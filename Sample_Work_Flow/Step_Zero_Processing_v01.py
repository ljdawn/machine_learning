...
def preprocessing(data_matrix, stand_flag = 0, discret_list = [], binar_list = [], binar_thr_list = []):
	assert len(binar_list) - len(binar_thr_list) == 0
	import numpy as np
	from sklearn import preprocessing
...
if __name__ == '__main__':
	...
	for item in table:
		print item
	#print preprocessing(table, discret_list = [3, 4], binar_list = [1, 2], binar_thr_list = [0, 10])
