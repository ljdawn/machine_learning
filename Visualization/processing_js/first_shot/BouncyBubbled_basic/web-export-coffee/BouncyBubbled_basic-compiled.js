...
SketchBouncybubbledbasic = (function() {
  ...
  Ball = (function() {
    ...
    function Ball(xpos, ypos, diamter) {
      this.xpos = xpos;
      this.ypos = ypos;
    ...
    Ball.prototype.move = function() {
      if (this.ypos === height - this.diamter / 2) {
        this.vx *= this.fur;
      }
      ...
      this.xpos += this.vx;
      this.ypos += this.vy;
      if ((this.xpos + this.diamter / 2) > width) {
        this.xpos = width - this.diamter / 2;
        this.vx *= this.fri;
      } else if ((this.xpos - this.diamter / 2) < 0) {
        this.xpos = this.diamter / 2;
        this.vx *= this.fri;
      }
      if ((this.ypos + this.diamter / 2) > height) {
        this.ypos = height - this.diamter / 2;
        return this.vy *= this.fri;
      } else if ((this.ypos - this.diamter / 2) < 0) {
        this.ypos = this.diamter / 2;
        return this.vy *= this.fri;
      }
    };
    ...
    Ball.prototype.display = function() {
      fill(255, 50);
      return ellipse(this.xpos, this.ypos, this.diamter, this.diamter);
    };
