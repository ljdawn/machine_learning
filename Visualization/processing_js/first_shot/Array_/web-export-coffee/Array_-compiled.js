...
SketchArray = (function() {
  ...
  SketchArray.name = 'SketchArray';

  function SketchArray() {}
  ...
  */
  ...
  SketchArray.prototype.setup = function() {
    ...
    for (i = _i = 0; 0 <= width ? _i < width : _i > width; i = 0 <= width ? ++_i : --_i) {
      ...
      println(i);
      println(amount);
      this.coswave.push(abs(cos(amount)));
    }
    return noLoop;
  };

  SketchArray.prototype.draw = function() {
